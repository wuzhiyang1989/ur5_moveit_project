...
class URRobot(object):
    ...
    def movej(self, joints, acc, vel, wait=True, relative=False, threshold=None):
    ...
    def movel(self, tpose, acc, vel, wait=True, relative=False, threshold=None):
        """
    ...
    def movep(self, tpose, acc, vel, wait=True, relative=False, threshold=None):
        """
